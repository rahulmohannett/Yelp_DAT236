...
import { fetchRestaurantsThunk, setFilters as setReduxFilters } from '../store/restaurantSlice';
...
function SearchPage() {
    ...
    const loadRestaurants = useCallback(() => {
        ...
        dispatch(fetchRestaurantsThunk(searchFilters));
    }, [filters, buildKeywords, dispatch]);
