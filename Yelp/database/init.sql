...
-- ============================================================
-- Sample data (password = "password" hashed with bcrypt 4.0.1 via passlib)
-- ============================================================

INSERT INTO users (email, password_hash, name, role, city, state, country) VALUES
('customer@test.com', '$2b$12$rO6kzVLbgUwmv2e4j9UAoeQghD4h6qjbHeGUIEaepCmuqel0g.BHa', 'Test Customer', 'customer', 'San Francisco', 'CA', 'USA'),
('owner@test.com', '$2b$12$rO6kzVLbgUwmv2e4j9UAoeQghD4h6qjbHeGUIEaepCmuqel0g.BHa', 'Test Owner', 'owner', 'San Francisco', 'CA', 'USA');
